        ...
        <div class="row">
            <div class="col-xl-4 col-lg-5">
                <div class="card text-center">
                    <div class="card-body">
                        @if (Auth::user()->image=='')
                        <img src="{{asset('assets/images/demouser.png')}}" class="rounded-circle avatar-lg img-thumbnail" alt="profile-image">
                        @else
                        <img src="{{asset('uploads/userImage/'.Auth::user()->image)}}" class="rounded-circle avatar-lg img-thumbnail" alt="profile-image">
                        @endif
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <span class="form-text text-muted"><small>If you do not want to change password please keep it blank </small></span>
                                            </div>
                                        </div> <!-- end col -->
                                        <div class="col-md-6">
                                            <div class="mb-3">
