            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <span class="account-user-avatar">
                        @if (Auth::user()->image=='')
                        <img src="{{asset('assets/images/demouser.png')}}" alt="user-image" width="32" class="rounded-circle">
                        @else
                        <img src="{{asset('uploads/userImage/'.Auth::user()->image)}}" alt="user-image" width="32" height="32" class="rounded-circle">
                        @endif
